...
from projects.serializers import ProjectSerializerWithReport, ProjectSerializerstartswithA, Projectserializers
...
import json
from users.serializers import CustomUserWithProjectStats, CustomUserserializer, UserPendingTodoStatsSerializer, UserTodoStatsSerializer
...
def fetch_project_wise_report():
    ...
    return ProjectSerializerWithReport(projects,many=True).data
...
def fetch_user_wise_project_status():
    ...
    return CustomUserWithProjectStats(users, many=True).data
